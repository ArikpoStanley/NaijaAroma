...
export class EmailService {
   ...
   */
  static async sendOrderConfirmation(email: string, orderData: OrderEmailData): Promise<boolean> {
    const html = `
      <!DOCTYPE html>
      <html>
      <head>
   ...
   */
  static async sendCateringInquiryNotification(inquiryData: CateringEmailData): Promise<boolean> {
