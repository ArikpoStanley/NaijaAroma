...
export const orderResolvers = {
  ...
  Mutation: {
    createOrder: async (_: unknown, { input }: { input: CreateOrderInput }, context: Context) => {
      ...
      const validatedInput = validateInput<CreateOrderInput>(orderValidation, input);
    ...
    updateOrderStatus: async (_: unknown, { id, input }: { id: string; input: UpdateOrderStatusInput }, context: Context) => {
  ...
  OrderItem: {
    menuItem: async (parent: { menuItemId: string }) => {
